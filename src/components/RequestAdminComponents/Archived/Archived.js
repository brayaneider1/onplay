...
import { Check } from "../../Modals/Admin/Check";

export const Archived = ({ data, success, archived, check }) => {
                ...
                <Tr>
                  ...
                  <Td className="relative">
                    <div className="actions-container">
                      ...
                      {check && <FaCheckCircle onClick={() => onHandleCheck(i)} className="cursor-pointer ml-3 text-2xl text-blue-500 " />}
